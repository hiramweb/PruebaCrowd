                    ...
                    <div class="row-fluid">
                        <div class="span9">
                            <div class="panel right-line">
                                        ...
                                        <div class="grid-item grid-style-properties">
                                            <div class="item">
                                                <a href="#" class="with-hover">
                                                    ...
                                                    <img alt='images' src="<?php echo URL?>proper_theme/images/properties/p2.jpg" class="full"/><span class="mask_hover"></span>
                                                </a>
                                                <h4 class=" ">34 Central Park</h4>
                                            ...
                                            <div class="item">
                                                <a href="#" class="with-hover">
                                                    <div class="for_rent_banner"></div>
                                                    <img alt='images' src="<?php echo URL?>proper_theme/images/properties/p3.jpg" class="full"/><span class="mask_hover"></span>
                                                </a>
                                                <h4 class="">34 Central Park</h4>
                                                <div class="preview-properties ">
                                                    <div class="box-detail"> 
                                            ...
                                            <div class="item">
                                                <a href="#" class="with-hover">
                                                    <div class="for_sale_banner"></div>
                                                    <img alt='images' src="<?php echo URL?>proper_theme/images/properties/p4.jpg" class="full"/><span class="mask_hover"></span>
                                                </a>
                                                <h4 class="">34 Central Park</h4>
                                                <div class="preview-properties ">
                                                    <div class="box-detail"> 
                                            ...
                                            <div class="item">
                                                <a href="#" class="with-hover">
                                                    <div class="for_sale_banner"></div>
                                                    <img alt='images' src="<?php echo URL?>proper_theme/images/properties/p5.jpg" class="full"/><span class="mask_hover"></span>
                                                </a>
                                                <h4 class="">34 Central Park</h4>
                                                <div class="preview-properties ">
                                                    <div class="box-detail"> 
                                            ...
                                            <div class="item">
                                                <a href="#" class="with-hover">
                                                    <div class="for_sale_banner"></div>
                                                    <img alt='images' src="<?php echo URL?>proper_theme/images/properties/p6.jpg" class="full"/><span class="mask_hover"></span>
                                                </a>
                                                <h4 class="">34 Central Park</h4>
                                                <div class="preview-properties ">
                                                    <div class="box-detail"> 
                                            ...
                                            <div class="item">
                                                <a href="#" class="with-hover">
                                                    <div class="for_rent_banner"></div>
                                                    <img alt='images' src="proper_theme/images/properties/p7.jpg" class="full"/><span class="mask_hover"></span>
                                                </a>
                                                <h4 class="">34 Central Park</h4>
                                                <div class="preview-properties ">
                                                    <div class="box-detail"> 
                                ...
                                <!--Start New List-->
                                <h2 class="main-heading bottom-line top-line "><span class="main-circle-icon"><i class="icon-book"></i></span> News</h2>   
                                <div class=" news right-space">
                                    <div class="media box-white">
                                        <a class="pull-left" href="#">
                                            <img alt="images" class="media-object" src="proper_theme/images/news/thum/n1.jpg">
                                        </a>
...
$( document ).ready(function() {
    $("#a_cerrarSesion").click(function (){
        $.post('<?php echo RAIZ."index.php/login/salir/" ?>',
        function(r){
            if(r == 'true'){
