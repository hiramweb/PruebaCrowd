...
<html>
    <head>
        ...
        <!--[if IE 7]>
        <link rel="stylesheet" href="proper_theme/css/font-awesome-ie7.min.css">
        <![endif]-->
                ...
                <div class="container">
                    <div class="row-fluid">
                        <div class="span1 visible-desktop">                
                            <h2 class="main-heading bottom-line line-after ">&nbsp;</h2>   
                        </div>
                        <div class="span11">
                            <div class="panel left-line">
                                <h2 class="main-heading bottom-line visible-desktop">&nbsp;</h2>   

                                <div class="box-error box-panel">
                                    404
                                    <p>Lo sentimos, la página a la cual desea acceder no fue encontrada</p>
                                </div>

                                <a href="<?php echo RAIZ; ?>" class="btn btn-proper"><i class="icon-angle-left"></i> Regresar Inicio</a>
                            </div>
                        </div>
                    </div>
                </div>
