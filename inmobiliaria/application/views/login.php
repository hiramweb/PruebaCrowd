...
<html>
    <head>
        <title>Proper - Real Estate Responsive Template</title>
                    ...
                    <div class="panel">
                        <div class="row-fluid">
                            <div class="span9 right-line">
                                <a class="brand" href="<?php echo RAIZ; ?>" ><h1 class="font-caly"><img src="<?php echo URL?>proper_theme/images/lextres.jpg" width="90" height="60" alt="logo">Lextres <small class="visible-desktop visible-tablet">Bienes y Raices</small></h1></a>
                            </div>
                            <!--div class="span3 ">
                                <div class="clearfix">
                                    ...
                                    <ul class="nav">
                                        <li class="dropdown">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li><a href="home_full_slider.html">Home Full Slider</a></li>
                                                <li><a href="home_carousel.html">Home Slider Carousel</a></li>
                                                <li><a href="index.html">Home With Map</a></li>
                                                <li><a href="home_simple.html">Home Simple</a></li>
                                            </ul>
                                        </li>
                                        <li class="dropdown">
                                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">Properties <b class="caret"></b></a>
                                            <ul class="dropdown-menu">
                                                <li><a href="properties_filter.html">Properties & Filter</a></li>
                                                <li><a href="properties_map.html">Properties & Map</a></li>
                                                <li><a href="properties_detail.html">Properties Detail</a></li>
                                            </ul>
            ...
            <div id="content">
                ...
                <div class="container">
                    <div class="panel proper-form-bg">
                        <form class="proper-login" action="<?php echo REDIRECT ?>login/acceder/" method="post">
                            <div class="member-login">
                                <img src="<?php echo URL?>proper_theme/images/logo.png" class="img-polaroid" width="90" alt="image-login"/>
                                <div class="member-desc">
                                    <h3>Login Sistema</h3>
                                    <a href="#">Por favor ingrese sus datos</a>
                                </div>
                                <div class="clearfix"></div>  
                                <hr/>
                            </div>
                            <label>Nombre de Usuario</label>
                            <input type="text" id="usuario" name="usuario" class="input-block-level"/>
                            ...
                            <hr/>
                            <div class="clearfix">
                                <input type="submit" value="Acceder" class="btn btn-proper"/>&nbsp;&nbsp; <a href="#">¿Olvido su Contraseña?</a>
                            </div>
                        </form>
                    </div>
                ...
                <div id="footer-top">
                    <div class="container">
                        <div class="row-fluid">
                            <div class="span3">
                                <div class="panel">
                                    <h4><i class="icon-time"></i> Contácto</h4>
                            ...
                            <div class="span3">
                                <div class="panel">
                                    <h4><i class="icon-screenshot"></i> Información</h4>
